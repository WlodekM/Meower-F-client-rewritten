...
<Container>
	...
	F Client Re-Written, v{version}
	<br />
	All of F Client is free and open-source!
	<a href="https://github.com/WlodekM/Meower-F-client-rewritten/">See the source code here.</a>
</Container>
<Container>
	<h2>Credits</h2>
	...
	<ul>
		<li>
			<a href="https://{window.location.href}/users/MikeDEV">@MikeDEV</a>
		...
		<li>
			<a href="https://{window.location.href}/users/silvxrcat">@silvxrcat</a>
	...
	<ul>
		<li>
			<a href="https://{window.location.href}/users/WlodekM3">@WlodekM3</a>
	...
	<ul>
		{#each FCLIENTCONTRIBUTORS as username}
			<li>
				{#if MEOWER_USERNAMES[username] !== null}
					<a href="https://{window.location.href}/users/{(MEOWER_USERNAMES[username] || username)}">
						@{MEOWER_USERNAMES[username] || username}
					</a>
					{:else}
